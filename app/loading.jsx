...
export default function Loading({msg}) {
    return (
        <div className={`flex text-white gap-3  h-screen w-screen flex-col z-50`}>
            <div className="flex text-6xl justify-center items-center h-full w-full animate-pulse transition-all">
                <Logo/>
            </div> 
            <div className="flex justify-center items-center mb-10 flex-row gap-2 text-white text-center">
